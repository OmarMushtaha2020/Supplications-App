                                      ...
                                      onPressed: () {
                                        if (form.currentState!.validate()) {
                                          AppCubit.get(context)
                                              ...
                                              number: int.parse(
                                                  numberOfSupplications.text.toString()))
                                              .then((value) {
              ...
              child: Container(
                ...
                child: Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      Text("المجموع:",style: TextStyle(color: Colors.white,fontSize: 20,decoration: TextDecoration.none,))
,
                      Text("${AppCubit.get(context).sum}",
                          style: TextStyle(
                            color: Colors.white,
                            fontSize: 15,
